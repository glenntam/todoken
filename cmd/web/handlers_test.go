...
import (
	...
	"github.com/glenntam/todoken/internal/password"
	"github.com/glenntam/todoken/internal/token"
)
...
func TestSignup(t *testing.T) {
	...
	t.Run("POST creates new user and redirects", func(t *testing.T) {
		...
		req.PostForm.Add("Email", "zara@github.com/glenntam/todoken")
		...
		user, found, err := app.db.GetUserByEmail("zara@github.com/glenntam/todoken")
		if err != nil {
			t.Fatal(err)
		}
	...
	t.Run("POST rejects invalid data and re-displays the form", func(t *testing.T) {
		tests := []struct {
			...
			},
			{
				...
				userEmail:    "zoe@github.com/glenntam/todoken",
				userPassword: "",
			},
			{
	...
	t.Run("POST rejects invalid credentials and re-displays the form", func(t *testing.T) {
		tests := []struct {
			...
			},
			{
				...
				userEmail:    "zaha@github.com/glenntam/todoken",
				userPassword: testUsers["alice"].password,
			},
			{
	...
	t.Run("POST rejects invalid data and re-displays the form", func(t *testing.T) {
		tests := []struct {
			...
			},
			{
				...
				userEmail: "zion@github.com/glenntam/todoken",
			},
		}
