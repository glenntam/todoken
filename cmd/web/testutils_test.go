...
var testUsers = map[string]*testUser{
	"alice": {email: "alice@github.com/glenntam/todoken", password: "testPass123!", hashedPassword: "$2a$04$27fHaQw5jwiMKYoxhLek4uyj9zp29lxtmLWGuC0MR6tuispXJn9US"},
	"bob":   {email: "bob@github.com/glenntam/todoken", password: "mySecure456#", hashedPassword: "$2a$04$O6QOPBSFw14SyLBXs64MJuQd8o7GaBKYvbDqeHGgZRi6FN87aXDWC"},
}
...
func newTestApplication(t *testing.T) *application {
	...
	app.db = newTestDB(t)
	app.mailer = smtp.NewMockMailer("test@github.com/glenntam/todoken")
