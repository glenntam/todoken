...
func TestMatches(t *testing.T) {
	tests := []struct {
		...
		{"Email-like pattern", "test@github.com/glenntam/todoken", ".*@.*", true},
...
func TestIsEmail(t *testing.T) {
	tests := []struct {
		...
		{"Valid simple email", "test@github.com/glenntam/todoken", true},
		{"Valid email with subdomain", "user@mail.github.com/glenntam/todoken", true},
		{"Valid email with numbers", "user123@example.org", true},
		{"Valid email with special chars", "user.name+tag@github.com/glenntam/todoken", true},
		{"Invalid email no @", "testgithub.com/glenntam/todoken", false},
		{"Invalid email no domain", "test@", false},
		{"Invalid email no local", "@github.com/glenntam/todoken", false},
		{"Invalid email multiple @", "test@@github.com/glenntam/todoken", false},
		{"Empty string", "", false},
		{"Just @", "@", false},
		{"Too long email", strings.Repeat("a", 250) + "@github.com/glenntam/todoken", false},
...
func TestIsURL(t *testing.T) {
	tests := []struct {
		...
		{"Valid HTTP URL", "http://github.com/glenntam/todoken", true},
		{"Valid HTTPS URL", "https://github.com/glenntam/todoken", true},
		{"Valid URL with path", "https://github.com/glenntam/todoken/path", true},
		{"Valid URL with query", "https://github.com/glenntam/todoken?query=value", true},
		{"Valid URL with port", "https://github.com/glenntam/todoken:8080", true},
		{"Invalid URL no scheme", "github.com/glenntam/todoken", false},
		{"Invalid URL no host", "https://", false},
		{"Invalid URL scheme only", "https", false},
		{"Empty string", "", false},
		{"Just scheme", "http://", false},
		{"FTP URL", "ftp://files.github.com/glenntam/todoken", true},
		{"Custom scheme", "custom://github.com/glenntam/todoken", true},
	}
