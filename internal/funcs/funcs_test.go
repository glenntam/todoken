...
func TestUrlSetParam(t *testing.T) {
	t.Run("Sets new parameter", func(t *testing.T) {
		u, _ := url.Parse("https://github.com/glenntam/todoken/path")

		result := urlSetParam(u, "foo", "bar")

		assert.Equal(t, "foo=bar", result.RawQuery)
		assert.Equal(t, "https://github.com/glenntam/todoken/path", result.Scheme+"://"+result.Host+result.Path)
	})

	t.Run("Updates existing parameter", func(t *testing.T) {
		u, _ := url.Parse("https://github.com/glenntam/todoken/path?foo=old")
	...
	t.Run("Preserves existing parameters", func(t *testing.T) {
		u, _ := url.Parse("https://github.com/glenntam/todoken/path?existing=value")
...
func TestUrlDelParam(t *testing.T) {
	t.Run("Deletes existing parameter", func(t *testing.T) {
		u, _ := url.Parse("https://github.com/glenntam/todoken/path?foo=bar&baz=qux")
	...
	t.Run("Does nothing for non-existent parameter", func(t *testing.T) {
		u, _ := url.Parse("https://github.com/glenntam/todoken/path?foo=bar")
